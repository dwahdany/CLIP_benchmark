...
def build_dataset(
    ...
    **kwargs,
    ...
    """
    use_classnames_and_templates = task in (
    ...
    elif dataset_name.startswith("fairvision/"):
        name = dataset_name.split("/", 1)[1]
        cls = getattr(fairvision, name)
        ds = cls(
            root_dir=root,
            transform=transform,
            stage=split,
...
def build_vtab_dataset(
    ...
    if dataset_name == "caltech101":
        ...
        if not os.path.exists(data_dir):
            ...
            call(
                f"cd {data_dir}/downloads/manual;unrar x resisc45.rar",
                shell=True,
            )
